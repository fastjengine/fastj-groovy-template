...
1. Clone the repository via terminal: `git clone https://github.com/lucasstarsz/fastj-groovy-template`

#### Downloading the latest release
Download the archive (.zip file, or tar.gz file) from https://github.com/lucasstarsz/fastj-groovy-template/releases/latest
